...
var SpotifyMessage = function (_a) {
    ...
    if (!props.uri)
        return null;
    return ((0, jsx_runtime_1.jsx)("div", __assign({ className: 'rce-mbox-spotify' }, { children: (0, jsx_runtime_1.jsx)("iframe", { src: 'https://open.spotify.com/embed?' + toUrl(), width: width, height: height, frameBorder: '0', allowTransparency: true }) })));
};
