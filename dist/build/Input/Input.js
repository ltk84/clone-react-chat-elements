...
var Input = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: (0, classnames_1.default)('rce-container-input', props.className) }, { children: [props.leftButtons && (0, jsx_runtime_1.jsx)("div", __assign({ className: 'rce-input-buttons' }, { children: props.leftButtons })), multiline === false ? ((0, jsx_runtime_1.jsx)("input", { ref: props.referance, type: type, className: (0, classnames_1.default)('rce-input'), placeholder: props.placeholder, defaultValue: props.defaultValue, style: props.inputStyle, onChange: onChangeEvent, onCopy: props.onCopy, onCut: props.onCut, onPaste: props.onPaste, onBlur: props.onBlur, onFocus: props.onFocus, onSelect: props.onSelect, onSubmit: props.onSubmit, onReset: props.onReset, onKeyDown: props.onKeyDown, onKeyPress: props.onKeyPress, onKeyUp: props.onKeyUp })) : ((0, jsx_runtime_1.jsx)("textarea", { ref: props.referance, className: (0, classnames_1.default)('rce-input', 'rce-input-textarea'), placeholder: props.placeholder, defaultValue: props.defaultValue, style: props.inputStyle, onChange: onChangeEvent, onCopy: props.onCopy, onCut: props.onCut, onPaste: props.onPaste, onBlur: props.onBlur, onFocus: props.onFocus, onSelect: props.onSelect, onSubmit: props.onSubmit, onReset: props.onReset, onKeyDown: props.onKeyDown, onKeyPress: props.onKeyPress, onKeyUp: props.onKeyUp })), props.rightButtons && (0, jsx_runtime_1.jsx)("div", __assign({ className: 'rce-input-buttons' }, { children: props.rightButtons }))] })));
};
